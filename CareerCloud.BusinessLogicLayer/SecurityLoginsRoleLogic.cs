...
namespace CareerCloud.BusinessLogicLayer
{
    public class SecurityLoginsRoleLogic : BaseLogic<SecurityLoginsRolePoco>
    {
        ...
        // {
        //     SecurityLoginsRolePoco poco = base.GetAll().Where(s => s.Login == userName).FirstOrDefault();
        //     if (null == poco)
        //     {
        //         return false;
        //     }
        ...
        protected override void Verify(SecurityLoginsRolePoco[] pocos)
        {
            ...
            //     {
            //         exceptions.Add(new ValidationException(700, $"Password for SecurityLoginsRole {poco.Id} cannot be null"));
            //     }
            //     else if (poco.Password.Length < 10)
            //     {
            //         exceptions.Add(new ValidationException(700, $"Password for SecurityLoginsRole {poco.Id} must be at least 10 characters."));
            //     }
            //     else if (!requiredExtendedPasswordChars.Any(t => poco.Password.Contains(t)))
            //     {
            //         exceptions.Add(new ValidationException(701, $"Password for SecurityLoginsRole {poco.Id} must contain an extended character of '$', '*', '#', '_' or '@' ."));
            //     }

            //     if (string.IsNullOrEmpty(poco.PhoneNumber))
            //     {
            //         exceptions.Add(new ValidationException(702, $"PhoneNumber for SecurityLoginsRole {poco.Id} is required"));
            //     }
            //     else
            //     {
            ...
            //         {
            //             exceptions.Add(new ValidationException(703, $"PhoneNumber for SecurityLoginsRole {poco.Id} is not in the required format."));
            //         }
            //         else
            //         {
            ...
            //     {
            //         exceptions.Add(new ValidationException(704, "EmailAddress for SecurityLoginsRole {poco.Id} is not a valid email address format."));
            //     }
            ...
            //     {
            //         exceptions.Add(new ValidationException(705, "FullName for SecurityLoginsRole {poco.Id} is required."));
            //     }
