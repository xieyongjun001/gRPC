    ...
    public class ApplicantSkillLogic : BaseLogic<ApplicantSkillPoco>
    {
        ...
        protected override void Verify(ApplicantSkillPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(101, $"StartYear  ApplicantSkill {poco.Id} cannot be greater then 12"));
                }

                if (poco.EndMonth > 12)
                {
                    exceptions.Add(new ValidationException(102, $"EndMonth ApplicantSkill {poco.Id} cannot be greater then 12"));
                }
