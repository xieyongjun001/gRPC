...
namespace CareerCloud.BusinessLogicLayer
{
    public class SecurityLoginsLogLogic : BaseLogic<SecurityLoginsLogPoco>
    {
        ...
        // {
        //     SecurityLoginsLogPoco poco = base.GetAll().Where(s => s.Login == userName).FirstOrDefault();
        //     if (null == poco)
        //     {
        //         return false;
        //     }
        ...
        protected override void Verify(SecurityLoginsLogPoco[] pocos)
        {
            ...
            //     {
            //         exceptions.Add(new ValidationException(700, $"Password for SecurityLoginsLog {poco.Id} cannot be null"));
            //     }
            //     else if (poco.Password.Length < 10)
            //     {
            //         exceptions.Add(new ValidationException(700, $"Password for SecurityLoginsLog {poco.Id} must be at least 10 characters."));
            //     }
            //     else if (!requiredExtendedPasswordChars.Any(t => poco.Password.Contains(t)))
            //     {
            //         exceptions.Add(new ValidationException(701, $"Password for SecurityLoginsLog {poco.Id} must contain an extended character of '$', '*', '#', '_' or '@' ."));
            //     }

            //     if (string.IsNullOrEmpty(poco.PhoneNumber))
            //     {
            //         exceptions.Add(new ValidationException(702, $"PhoneNumber for SecurityLoginsLog {poco.Id} is required"));
            //     }
            //     else
            //     {
            ...
            //         {
            //             exceptions.Add(new ValidationException(703, $"PhoneNumber for SecurityLoginsLog {poco.Id} is not in the required format."));
            //         }
            //         else
            //         {
            ...
            //     {
            //         exceptions.Add(new ValidationException(704, "EmailAddress for SecurityLoginsLog {poco.Id} is not a valid email address format."));
            //     }
            ...
            //     {
            //         exceptions.Add(new ValidationException(705, "FullName for SecurityLoginsLog {poco.Id} is required."));
            //     }
