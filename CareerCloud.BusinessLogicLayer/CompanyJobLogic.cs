...
namespace CareerCloud.BusinessLogicLayer
{
    public class CompanyJobLogic : BaseLogic<CompanyJobPoco>
    {
        ...
        protected override void Verify(CompanyJobPoco[] pocos)
        {
            ...
            //     {
            //         exceptions.Add(new ValidationException(700, $"Password for CompanyJob {poco.Id} cannot be null"));
            //     }
            //     else if (poco.Password.Length < 10)
            //     {
            //         exceptions.Add(new ValidationException(700, $"Password for CompanyJob {poco.Id} must be at least 10 characters."));
            //     }
            //     else if (!requiredExtendedPasswordChars.Any(t => poco.Password.Contains(t)))
            //     {
            //         exceptions.Add(new ValidationException(701, $"Password for CompanyJob {poco.Id} must contain an extended character of '$', '*', '#', '_' or '@' ."));
            //     }

            //     if (string.IsNullOrEmpty(poco.PhoneNumber))
            //     {
            //         exceptions.Add(new ValidationException(702, $"PhoneNumber for CompanyJob {poco.Id} is required"));
            //     }
            //     else
            //     {
            ...
            //         {
            //             exceptions.Add(new ValidationException(703, $"PhoneNumber for CompanyJob {poco.Id} is not in the required format."));
            //         }
            //         else
            //         {
            ...
            //     {
            //         exceptions.Add(new ValidationException(704, "EmailAddress for CompanyJob {poco.Id} is not a valid email address format."));
            //     }
            ...
            //     {
            //         exceptions.Add(new ValidationException(705, "FullName for CompanyJob {poco.Id} is required."));
            //     }
