...
{
    public class ApplicationEducationLogic : BaseLogic<ApplicationEducationPoco>
    {

        public ApplicationEducationLogic(IDataRepository<ApplicationEducationPoco> repository) : base(repository)
        {
        }

        // public bool Authenticate(string userName, string password)
        // {
        //     ApplicationEducationPoco poco = base.GetAll().Where(s => s.Login == userName).FirstOrDefault();
        //     if (null == poco)
        //     {
        //         return false;
        //     }
        ...
        // }
         ...
         public override void Add(ApplicationEducationPoco[] pocos)
         {
             Verify(pocos);
        //     foreach (ApplicationEducationPoco poco in pocos)
        //     {
        ...
        public override void Update(ApplicationEducationPoco[] pocos)
        {
            Verify(pocos);
            base.Update(pocos);
        }

        protected override void Verify(ApplicationEducationPoco[] pocos)
        {
